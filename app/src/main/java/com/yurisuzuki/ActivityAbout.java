...
public class ActivityAbout extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView gplTextView = findViewById(R.id.about_gpl_link);
        TextView lgplTextView = findViewById(R.id.about_lgpl_link);
        TextView privacyPolicyTextView = findViewById(R.id.about_privacy_policy_link);
