...
public class CameraActivity extends ARActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		cameraSwapButton0 = findViewById(R.id.rear_front_switch_portlait0);
		currentInstrumentIcon0 = findViewById(R.id.current_instrument_icon_portlait0);
		currentInstrumentIcon0_Piano = findViewById(R.id.current_instrument_icon_portlait0_piano);
		currentInstrumentIcon0_MusicBox = findViewById(R.id.current_instrument_icon_portlait0_mb);
		infoButton0 = findViewById(R.id.info_icon_portlait0);
		guitarSwitch0 = findViewById(R.id.guitar_switch_portlait0);
		octaveSwitch0 = findViewById(R.id.octave_switch_portlait0);

		cameraSwapButton90 = findViewById(R.id.rear_front_switch_landscape90);
		currentInstrumentIcon90 = findViewById(R.id.current_instrument_icon_landscape90);
		infoButton90 = findViewById(R.id.info_icon_landscape90);
		guitarSwitch90 = findViewById(R.id.guitar_switch_landscape90);
		octaveSwitch90 = findViewById(R.id.octave_switch_landscape90);

		cameraSwapButton180 = findViewById(R.id.rear_front_switch_portlait180);
		currentInstrumentIcon180 = findViewById(R.id.current_instrument_icon_portlait180);
		currentInstrumentIcon180_Piano = findViewById(R.id.current_instrument_icon_portlait180_piano);
		currentInstrumentIcon180_MusicBox = findViewById(R.id.current_instrument_icon_portlait180_mb);
		infoButton180 = findViewById(R.id.info_icon_portlait180);
		guitarSwitch180 = findViewById(R.id.guitar_switch_portlait180);
		octaveSwitch180 = findViewById(R.id.octave_switch_portlait180);

		cameraSwapButton270 = findViewById(R.id.rear_front_switch_landscape270);
		currentInstrumentIcon270 = findViewById(R.id.current_instrument_icon_landscape270);
		infoButton270 = findViewById(R.id.info_icon_landscape270);
		guitarSwitch270 = findViewById(R.id.guitar_switch_landscape270);
		octaveSwitch270 = findViewById(R.id.octave_switch_landscape270);
	...
	private void loadSoundFiles(String[] soundPathes) {
		...
		String[] filePathes = list.toArray(new String[0]);
