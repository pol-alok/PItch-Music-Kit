...
public class ActivityMakeMarkerTrace extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        markerView = findViewById(R.id.trace_marker_image);
        leftButton = findViewById(R.id.to_left_marker_button);
        rightButton = findViewById(R.id.to_right_marker_button);

        guitarTabTitle = findViewById(R.id.marker_trace_guitar_tab_button);
        musicBoxTabTitle = findViewById(R.id.marker_trace_musicbox_tab_button);
        pianoTabTitle = findViewById(R.id.marker_trace_piano_tab_button);
